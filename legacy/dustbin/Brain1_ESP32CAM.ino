...
void setup() {
  ...
  RCCHECK(rclc_node_init_default(&node, "esp32_cam_node", "", &support));
  ...
  msg.header.frame_id.data = (char*)"camera_frame";
  msg.width = 320;
  msg.height = 240;
  msg.encoding.data = (char*)"jpeg";
  msg.step = 320;
}
