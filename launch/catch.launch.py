...
def generate_launch_description():
    ...
    # 3. Robot State Publisher (Lidar-free Version)
    urdf_file = os.path.join(pkg_share, 'models', 'mecanum_bot_vision.urdf')
    ...
    # 9. Specialized Image Bridge (High-performance Camera Feed)
    image_bridge = Node(
