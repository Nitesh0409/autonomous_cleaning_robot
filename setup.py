...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'planner_global_dstar = robot.planner_global_dstar:main',
            ...
            'projectile_launcher = robot.projectile_launcher:main',
            'interceptor = robot.interceptor:main',
            'mission_validator = robot.mission_validator:main',
            'nav_monitor = loggers.nav_monitor:main',
            'calibration_sequence = loggers.calibration_logger:main',
            'calib_verify = robot.calib_verify:main',
            'drift_analyzer = loggers.drift_analyzer:main',
